...
**Unsorted DGs:** fix requires per-CG record filtering in `mdf_decode` / `arrow_emit` / converter UDF, plus `rec_id_size`, `record_id`, and per-DG CG record sizes in partition specs.
