...
from mda_query_engine.persistence import FileSystem, LocalFS
...
class MeasurementDB:
    def __init__(self, config: MeasurementDBConfig, filesystem: FileSystem = LocalFS()):
        self.filesystem = filesystem
        self.config = config

    @property
    def query(self):
        return QueryBuilder(db=self, filesystem=self.filesystem)
...
class InMemoryMeasurementDB(MeasurementDB):
    def __init__(self, filesystem: FileSystem = LocalFS()):
        self.filesystem = filesystem
