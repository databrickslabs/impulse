...
from mda_query_engine.persistence import FileSystem
...
class QueryBuilder:
    def __init__(self, db: "mda_query_engine.analyze.MeasurementDB", filesystem: FileSystem):
        """
        ...
        filesystem : FileSystem
            Filesystem interface for data access.
        """
        self.db = db
    ...
    def solve(
        ...
        channel_tags_df = solver.filter_channel_tags(
            spark, self.db, metrics_df, direct_selectors
        )
