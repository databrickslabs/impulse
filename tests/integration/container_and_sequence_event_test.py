...
def test_container_event_in_report(spark, basic_narrow_db):
    ...
    my_report = Report(name="container_event_report", spark=spark, config=dict(mda_config))
...
def test_container_event_with_basic_event(spark, basic_narrow_db):
    ...
    my_report = Report(name="mixed_events_report", spark=spark, config=dict(mda_config))
...
def test_sequence_of_events_without_max_overlap_in_report(spark, basic_narrow_db):
    ...
    my_report = Report(name="sequence_event_report", spark=spark, config=dict(mda_config))
