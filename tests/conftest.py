...
@pytest.fixture
def basic_narrow_db(spark) -> MeasurementDB:
...
@pytest.fixture
def narrow_db(spark, setup_narrow_db) -> MeasurementDB:
...
@pytest.fixture
def key_value_store_db(spark, setup_key_value_store_db) -> MeasurementDB:
...
@pytest.fixture
def key_value_store_alias_db(spark, setup_key_value_store_alias_db) -> MeasurementDB:
